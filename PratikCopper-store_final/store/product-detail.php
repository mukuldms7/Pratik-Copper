			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h2 class="bread"><span><a href="home.html">Home</a></span> <span><a href="shop.html">Product</a></span> <span>Product Detail</span></h2>
				   				</div>
				   			</div>
				   		</div> 
			   		</div>
								...
								<div class="col-md-7">
									<div class="desc">
										...
										<div class="size-wrap">
											<p class="size-desc">
												Size: 
												<a href="javascript:void(0);" class="size size-1" onclick="new1()">xs</a>
